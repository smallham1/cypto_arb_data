...
def cex_orderbook_function():
    ...
    cex_xlm_orderflow_json_unf = exchange.fetch_order_book('XLM/USDT')
    ...
    add_cex_ask_data = (
        'INSERT INTO `cex_ask_feed` (`id`, `cex_ask1`, `cex_ask_amount1`, `cex_ask2`, `cex_ask_amount2`, `cex_ask3`, `cex_ask_amount3`, `created_at`, `updated_at`) VALUES ({},{},{},{},{},{},{},{},{})'.format(
            'NULL', cex_xlm_askprice_1st, cex_xlm_askprice_1st_quantity, cex_xlm_askprice_2nd, cex_xlm_askprice_2nd_quantity, cex_xlm_askprice_3rd,
            cex_xlm_askprice_3rd_quantity, 'NULL', 'NULL'))
    add_cex_bid_data = (
        'INSERT INTO `cex_bid_feed` (`id`, `cex_bid1`, `cex_bid_amount1`, `cex_bid2`, `cex_bid_amount2`, `cex_bid3`, `cex_bid_amount3`, `created_at`, `updated_at`) VALUES ({},{},{},{},{},{},{},{},{})'.format(
            'NULL', cex_xlm_bidprice_1st, cex_xlm_bidprice_1st_quantity, cex_xlm_bidprice_2, cex_xlm_bidprice_2_quantity, cex_xlm_bidprice_3,
            cex_xlm_bidprice_3_quantity, 'NULL', 'NULL'))

    cursor.execute(add_cex_ask_data)
    cursor.execute(add_cex_bid_data)
    connection.commit()
